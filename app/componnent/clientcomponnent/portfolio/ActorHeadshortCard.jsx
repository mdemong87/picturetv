...
const ActorHeadShortCard = ({ data, currentIndex, setshowimageSlide, setcurrentItem }) => {
    ...
    return (
        ...
        <div onClick={() => { setshowimageSlide(true), setcurrentItem(data) }} className="w-full col-span-12 md:col-span-6 lg:col-span-3 relative top-0 left-0">
