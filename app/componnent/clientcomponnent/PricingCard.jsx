const PricingCard = ({ title, price, offer }) => {
    return (
        <div class="w-full col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3 p-8 md:p-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 transition duration-200">
            ...
            <ul role="list" class="space-y-5 my-7 h-fit">
                    ...
                    offer?.map((item, index) => {
                        return (
                            <li key={index} class="flex items-center">
                                ...
                                <span class="text-base font-normal leading-tight text-gray-500 ms-3">{item}</span>
                            </li>
                        )
                    })
                }
