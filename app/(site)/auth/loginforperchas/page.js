        ...
        <main className="h-fit pt-36 pb-14 w-screen">
            ...
            <div className="flex justify-center items-cetner w-full h-full">
                <div className="border border-gray-300 p-8 rounded-md h-fit w-fit">
                    <h2 className="text-2xl text-center font-bold text-shadow-lg text-gray-800">Login Fast</h2>
                    ...
                    <div
                        ...
                        <div className="text-center">
                            <p>
                                ...
                                <Link className="pcl2 pl-2 underline" href={'/auth/ragisterforperchas'}>Register</Link>
                            </p>
                            <p>OR</p>
