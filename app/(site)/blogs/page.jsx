                    ...
                    <aside className="col-span-12 md:col-span-4 w-full bg-[#8888887c] text-white rounded-md h-full p-5">
                        ...
                        <div className="col-span-6 lg:col-span-4 w-full mt-5">
                            ...
                            <p className="text-gray-300 pt-3 text-base">
                                ...
                                This collection offers a captivating, transpicuous vibe that exudes confidence and allure—making it perfect for the bride ready to make a bold statement. However, this is not a collection for the faint of heart; it&lsquo;s designed for those who dare to embrace their beauty with fearless sophistication.
                            </p>
                        ...
                        <div className="col-span-6 lg:col-span-4 w-full mt-5">
                            ...
                            <p className="text-gray-300 pt-3 text-base">
                                ...
                                Dennis Basso&lsquo;s collection is timeless yet fresh, offering modern, chic designs that feel as relevant for today&lsquo;s bride as they will for generations to come, making it perfect for women of any age who appreciate classic elegance with a contemporary edge.
                            </p>
